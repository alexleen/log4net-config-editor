...
{
    [TestFixture]
    public class RemoteSyslogFacilityTest
    {
        private RemoteSyslogFacility mSut;

        [SetUp]
        public void SetUp()
        {
            mSut = new RemoteSyslogFacility(new ReadOnlyCollection<IProperty>(new List<IProperty>()));
        }
