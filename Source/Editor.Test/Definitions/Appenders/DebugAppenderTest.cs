...
namespace Editor.Test.Definitions.Appenders
{
    ...
    public class DebugAppenderTest
    {
        ...
        public void SetUp()
        {
            ...
            mSut = new DebugAppender(configuration);
            mSut.Initialize();
        }
        ...
        {
            Assert.AreEqual("Debug Appender", mSut.Name);
        }
        ...
        {
            Assert.AreEqual(AppenderDescriptor.Debug, mSut.Descriptor);
        }
